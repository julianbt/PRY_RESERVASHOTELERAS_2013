 ...
 * @property string $empleado_rol_id
 *
...
class Horario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('horario_entrada, horario_salida, empleado_rol_id', 'required'),
			array('empleado_rol_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, horario_entrada, horario_salida, empleado_rol_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'empleadoRol' => array(self::BELONGS_TO, 'EmpleadoRol', 'empleado_rol_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('empleado_rol_id',$this->empleado_rol_id,true);
